...
Mesh* Mesh::GeneratePyramid() {
	...
	m->vertices[5] = Vector3(0.0f, -0.5f, -0.5f);
	//right face verticies
	m->vertices[6] = Vector3(0.5f, -0.5f, 0.5f);
	m->vertices[7] = Vector3(0.0f, 0.5f, 0.0f);
	m->vertices[8] = Vector3(0.0f, -0.5f, -0.5f);
	//bottom face verticies 
	m->vertices[9] = Vector3(0.0f, -0.5f, -0.5f);
	...
	m->colours[2] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);
	// colours face 2
	m->colours[3] = Vector4(0.7f, 0.3f, 0.0f, 1.0f);
	m->colours[4] = Vector4(0.0f, 0.7f, 0.3f, 1.0f);
	m->colours[5] = Vector4(0.3f, 0.0f, 0.7f, 1.0f);
	// colors face 3
	m->colours[6] = Vector4(0.2f, 0.8f, 0.0f, 1.0f);
	m->colours[7] = Vector4(0.0f, 0.2f, 0.8f, 1.0f);
	m->colours[8] = Vector4(0.8f, 0.0f, 0.2f, 1.0f);
    // colours face 4
	m->colours[9] = Vector4(0.1f, 0.9f, 0.0f, 1.0f);
	m->colours[10] = Vector4(0.0f, 0.1f, 0.9f, 1.0f);
	m->colours[11] = Vector4(0.9f, 0.0f, 0.1f, 1.0f);
...
Mesh* Mesh::GeneratefsPyramid() {
	Mesh* m = new Mesh();
	m->numVertices = 18;
	m->type = GL_TRIANGLE_STRIP;
	// front face vertices
	m->vertices = new Vector3[m->numVertices];
	m->vertices[0] = Vector3(0.0f, 0.7f, 0.0f);
	m->vertices[1] = Vector3(0.7f, -0.7f, -0.7f);
	m->vertices[2] = Vector3(-0.7f, -0.7f, 0.7f);
	//left face verticies 
	m->vertices[3] = Vector3(-0.7f, -0.7f, -0.7f);
	m->vertices[4] = Vector3(0.0f, 0.7f, 0.0f);
	m->vertices[5] = Vector3(-0.7f, -0.7f, 0.7f);
	//right face verticies
	m->vertices[6] = Vector3(0.7f, -0.7f, 0.7f);
	m->vertices[7] = Vector3(0.0f, 0.7f, 0.0f);
	m->vertices[8] = Vector3(0.7f, -0.7f, -0.7f);
	//back face verticies
	m->vertices[9] = Vector3(-0.7f, -0.7f, -0.7f);
	m->vertices[10] = Vector3(0.0f, 0.7f, 0.0f);
	m->vertices[11] = Vector3(0.7f, -0.7f, -0.7f);
	//bottom face verticies left
	m->vertices[12] = Vector3(-0.7f, -0.7f, -0.7f);
	m->vertices[13] = Vector3(-0.7f, -0.7f, 0.7f);
	m->vertices[14] = Vector3(0.7f, -0.7f, 0.7f);
	// bottom face right 
	m->vertices[15] = Vector3(-0.7f, -0.7f, -0.7f);
	m->vertices[16] = Vector3(0.7f, -0.7f, -0.7f);
	m->vertices[17] = Vector3(0.7f, -0.7f, 0.7f);


	//colours front face
	m->colours = new Vector4[m->numVertices];
	m->colours[0] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	m->colours[1] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	m->colours[2] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	// colours left face
	m->colours[0] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	m->colours[1] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	m->colours[2] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	...
	m->colours[1] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	m->colours[2] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	//colours bottom left face
	m->colours[12] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	m->colours[13] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	m->colours[14] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	//colours bottom right face
	m->colours[0] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	m->colours[1] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	m->colours[2] = Vector4(1.0f, 1.0f, 1.0f, 0.5f);
	...
	//texture face 5 bottom left
	m->textureCoords[12] = Vector2(0.5f, 0.0f);
	m->textureCoords[13] = Vector2(1.0f, 1.0f);
	m->textureCoords[14] = Vector2(0.0f, 1.0f);
	//texture face 5 bottom right
	m->textureCoords[12] = Vector2(0.5f, 0.0f);
	m->textureCoords[13] = Vector2(1.0f, 1.0f);
	m->textureCoords[14] = Vector2(0.0f, 1.0f);
